...
// Destino del redirect_uri configurado en el client OIDC `web-sicsaft` de Keycloak — ver
// devops/local/README.md "Cliente OIDC real (WEB)". Canjea el `code` por tokens y vuelve al hub.
