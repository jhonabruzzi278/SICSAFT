...
// tenía un solo test, ni unitario ni e2e (el e2e existente siembra tokens directo en
// sessionStorage para saltarse este flujo, ver tests/helpers.js).

const ISSUER = 'http://id.sicsaft.localhost';
const CLIENT_ID = 'client-1';
const CIS_URL = 'http://api.sicsaft.localhost';
const ORIGIN = 'http://ccp.sicsaft.localhost';
...
function base64url(json: string): string {
  ...
  // token-store.test.ts), por si algún claim de prueba lleva caracteres no-ASCII.
