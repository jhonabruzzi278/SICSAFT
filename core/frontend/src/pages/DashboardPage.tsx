...
export function DashboardPage() {
  ...
  async function cargarDatos() {
    ...
    setError(null);
    try {
      const [cobRes, estRes, catRes, areRes] = await Promise.allSettled([
      ...
      setError(err instanceof Error ? err.message : 'Error al sincronizar con CIP');
    } finally {
      setCargando(false);
    }
  }
  ...
  }, [terminoBusqueda, estadoFiltroTabla, categoriaSeleccionada]);
    ...
    return (
      <div className="space-y-6">
        <div className="border-b border-border pb-5">
          ...
          <h1 className="mt-1 text-2xl font-bold tracking-tight text-text">Resumen Institucional</h1>
          <p className="mt-0.5 text-sm text-text-dim">
            Monitoreo general de la organización y designación de profesionales de AFT.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-accent/30 bg-bg-card p-6 shadow-elev-1">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-text text-base">Inteligencia de Negocio Patrimonial (CIP)</h2>
              <p className="text-xs text-text-dim">
                El Centro de Inteligencia Patrimonial con analítica en tiempo real, gráficos predictivos y
                control de desvíos está disponible en <strong>Nivel 2 Enterprise</strong>.
              </p>
            </div>
          </div>
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col gap-4 border-b border-border pb-5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-text-dim">
            Monitoreo en tiempo real, proyección de inventario y analítica patrimonial directiva.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="group relative overflow-hidden rounded-2xl border border-border bg-bg-card p-6 shadow-elev-1 transition-all hover:border-border-strong hover:shadow-elev-2">
          ...
          <p className="mt-1 text-[0.75rem] text-text-faint">Patrimonio activo registrado en BPI</p>
        ...
        <div className="group relative overflow-hidden rounded-2xl border border-border bg-bg-card p-6 shadow-elev-1 transition-all hover:border-border-strong hover:shadow-elev-2">
          ...
          <p className="mt-1 text-[0.75rem] text-text-faint">Operando en sedes y áreas asignadas</p>
        ...
        <div className="group relative overflow-hidden rounded-2xl border border-border bg-bg-card p-6 shadow-elev-1 transition-all hover:border-border-strong hover:shadow-elev-2">
          ...
          <p className="mt-1 text-[0.75rem] text-text-faint">Revisión técnica preventiva / correctiva</p>
        ...
        <div className="group relative overflow-hidden rounded-2xl border border-border bg-bg-card p-6 shadow-elev-1 transition-all hover:border-border-strong hover:shadow-elev-2">
          ...
          <p className="mt-1 text-[0.75rem] text-text-faint">Obsolescencia o en proceso de donación</p>
            ...
            {areas.map((ar) => (
              ...
              >
                <div className="min-w-0 flex-1">
                  <p className="truncate text-xs font-semibold text-text">{ar.areaId}</p>
      ...
      <div className="rounded-2xl border border-border bg-bg-card p-6 shadow-elev-1">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
          <div>
            ...
            <p className="text-xs text-text-dim">Últimas incorporaciones y relevamientos verificados en BPI</p>
          </div>
                ...
                filasFiltradas.slice(0, 10).map((fila) => (
                  <tr key={fila.codigo} className="transition-colors hover:bg-bg-raised/60">
                    <td className="py-3 pr-4 font-mono font-medium text-text">
                      <span className="rounded bg-bg-raised px-1.5 py-0.5 ring-1 ring-border">{fila.codigo}</span>
                    </td>
