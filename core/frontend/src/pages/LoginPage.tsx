  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center">
      <Card className="w-full max-w-sm text-center">
        <h1 className="mb-2 text-xl font-semibold text-accent-strong">Portal del Directivo</h1>
        <p className="mb-6 text-sm text-text-dim">
          Iniciá sesión con tu cuenta de la organización para ver el dashboard ejecutivo y
          designar al Profesional de AFT.
        </p>
