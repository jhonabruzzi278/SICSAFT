...
> Fase F (portal de administración remota) sin efecto** — ver §5.
...
| 2 | `feat/sicsaft-core-nivel-selector` | A.1–A.4 + doc-sync (§4) | 1 |
...
- `aidlc-docs/sicsaft-core/design-artifacts/DOC-028-camino-a-cliente-final.md` — §4: el `.exe` ya
...
*(No lo cierro yo — es tu PR y tu decisión; queda anotado acá y en la doc-sync de §4.)*
...
[DOC-028](DOC-028-camino-a-cliente-final.md) (camino a cliente final; Fase F descartada por §5),
