...
// pg-boss es ESM-only ("type": "module" en su package.json) — cip/ compila a CommonJS
...
// migrar todo `cip/` a ESM. Mismo criterio que `core/src/eventos-outbox/create-pgboss-client.ts`.
