...
| RF-09 | Módulo Dashboard: séptimo módulo del hub, expone el primer dashboard de CIP (cobertura, áreas controladas, sesiones con veredicto, activos fuera de área/no localizados, incidencias, estado de AFT, categorías) — solo lectura, cualquier operador con contrato vigente en la organización, sin rol adicional. | 🟡 Diseñado (DOC-019), sin construir | DOC-014 §7.1/§7.2 (decisiones que DOC-019 resuelve), DOC-018 §6 |
