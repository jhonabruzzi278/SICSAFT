...
// del Sistema re-autentica cada sesion de navegador en vez de dejar un token vivo indefinidamente
// (mismo criterio que ccp/src/lib/oidc/token-store.ts, DOC-022).
const TOKENS_KEY = 'web-admin-sicsaft-oidc-tokens';
const PKCE_KEY = 'web-admin-sicsaft-oidc-pkce';
