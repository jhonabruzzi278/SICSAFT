...
| CIP | [`aidlc-docs/cip/requirements/REQUIREMENTS.md`](aidlc-docs/cip/requirements/REQUIREMENTS.md) | Fase 6 (primer dashboard) + Fase 9 (inteligencia decisional) | 17 | 7 | ✅ RF-01 a RF-10 completo (Fase 6) — RF-11 a RF-17 diseño únicamente, sin código todavía (Fase 9, [DOC-026](aidlc-docs/cip/design-artifacts/DOC-026-cip-inteligencia-decisional.md)). [DOC-034](aidlc-docs/cip/design-artifacts/DOC-034-alertas-entrelazadas-con-reportes.md)/[DOC-036](aidlc-docs/cip/design-artifacts/DOC-036-marcar-sesion-revisada-cip.md) ya tienen código real pero sin RF/RNF numerado, mismo tipo de deuda que CIS (ver nota abajo) |
